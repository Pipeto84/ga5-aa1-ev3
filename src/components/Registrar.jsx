    ...
    <div className="registro">
      <div className="contenido-registro">
        ...
        <div className="formulario-registro">
          ...
          <input type="text" placeholder="Escribe tu nombre" className="input-registro"/>
          ...
          <input type="text" placeholder="Escribe tu telefono" className="input-registro3"/>
          <label className="label-registro">Fecha de nacimiento</label>
          <input type="text" placeholder="Escribe tu fecha de nacimiento" className="input-registro4"/>
          <label className="label-registro">Email</label>
          <input type="text" placeholder="Escribe tu email" className="input-registro5"/>
          <label className="label-registro">Contrasena</label>
          <input type="text" placeholder="Escribe tu contrasena" className="input-registro6"/>
        </div>
